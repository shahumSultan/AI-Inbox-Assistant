    ...
    <footer className="border-t border-white/[0.06] py-16">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-14">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-8 h-8 rounded-xl bg-brand/10 border border-brand/30 flex items-center justify-center">
              ...
              <span className="text-white font-bold text-[17px]" style={{ fontFamily: "var(--font-syne)" }}>
                Inbox<span className="text-brand">AI</span>
              </span>
            </div>
            <p className="text-slate-600 text-sm leading-relaxed max-w-[175px]" style={{ fontFamily: "var(--font-dm-sans)" }}>
        ...
        <div className="border-t border-white/[0.05] pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-700 text-sm" style={{ fontFamily: "var(--font-dm-sans)" }}>
            © 2026 AI Inbox Assistant, Inc. All rights reserved.
          </p>
          <div className="flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald" />
            <span className="text-slate-600 text-xs" style={{ fontFamily: "var(--font-dm-sans)" }}>
